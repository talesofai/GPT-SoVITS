...
result_support_voice_info = run_celery_task(
    celery_app=celery_app, task_name="gpt_sovits_support_voice_info", queue_name='GPTSoVits')
...
# 调用生成音频的任务
audio_result = run_celery_task(celery_app=celery_app, task_name="gpt_sovits_generate_voice", queue_name='GPTSoVits',
                               speaker_name=speaker_name, text="你说的对，但是《原神》是由米哈游自主研发的一款全新开放世界冒险游戏", language="zh")

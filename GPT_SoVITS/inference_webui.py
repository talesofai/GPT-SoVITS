...
weight_root = "/root/autodl-tmp/models/GPT-SoVITS"
...
def get_weights_names():
    ...
    for name in os.listdir(weight_root):
        if not name.startswith("."):
            SoVITS_names.append(os.path.join(weight_root, name, "sovits.ckpt"))
            GPT_names.append(os.path.join(weight_root, name, "gpt.ckpt"))
    ...
    with gr.Column():
        ...
        with gr.Row():
            ...
            SoVITS_dropdown.change(
                tts_pipeline.init_vits_weights, [SoVITS_dropdown], []
            )
